...
controller.listar = async (req, res) => {
    // req = requisisão  res = resposta
    // find() sem parêametros é para trazer tudo(do Mecanico) do banco de dados
    // async e await SEMPRE estao juntas, siginifica que é assíncrona
    try {
        let dados = await Mecanico.find()
        res.send(dados)
...
controller.obterUm = async (req, res) => {
    ...
    let obj = await Mecanico.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let obj = await Mecanico.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        let obj = await Mecanico.findByIdAndDelete(id)
