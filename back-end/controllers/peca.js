...
controller.listar = async (req, res) => {
    // req = requisisão  res = resposta
    // find() sem parêametros é para trazer tudo(do Peca) do banco de dados
    // async e await SEMPRE estao juntas, siginifica que é assíncrona
    try {
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let obj = await Peca.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        let obj = await Peca.findByIdAndDelete(id)
